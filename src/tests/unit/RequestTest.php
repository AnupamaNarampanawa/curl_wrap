...
class RequestTest extends \PHPUnit\Framework\TestCase{
    public function testPosiibleGetRequests(){
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl GET https://google.com');

        //Get request with setting only the options
        $get_request=$request->setUrl('https://google.com')->setOptions(['--request'])->get();
        $this->assertEquals($request->getCurlTemplate(),'curl --request GET https://google.com');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl GET -H "Accept: application/json" https://google.com');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --require GET -H "Accept: application/json" https://google.com');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --require --location GET -H "Accept: application/json" https://google.com');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --require GET -H "Accept: application/json" -H "Authorization: Bearer {token}" https://google.com');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --require GET -H "Accept: application/json" -u "username:password" https://google.com');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --require GET -H "Accept: application/json" -H "Authorization: Bearer {123456} https://google.com');
    }
    ...
    public function testPossiblePostRequests(){
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl POST -d "{test&test}" https://google.com');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --request POST -d "{test&test}" https://google.com');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl POST -H "Accept: application/json" -d "{test&test}" https://google.com');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --require POST -H "Accept: application/json" -d "{test&test}" https://google.com');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --require --location POST -H "Accept: application/json" -d "{test&test}" https://google.com');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --require POST -H "Accept: application/json" -H "Authorization: Bearer {token}" -d "{test&test}" https://google.com');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --require POST -H "Accept: application/json" -H "Authorization: Bearer {123456} -d "{test&test}" https://google.com');
    }
    ...
    public function testPossiblePutRequests(){
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl PUT -d "{test&test}" https://google.com?id=1');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --request PUT -d "{test&test}" https://google.com?id=1');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl PUT -H "Accept: application/json" -d "{test&test}" https://google.com?id=1');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --require PUT -H "Accept: application/json" -d "{test&test}" https://google.com?id=1');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --require --location PUT -H "Accept: application/json" -d "{test&test}" https://google.com?id=1');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --require PUT -H "Accept: application/json" -H "Authorization: Bearer {token}" -d "{test&test}" https://google.com?id=1');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --require PUT -H "Accept: application/json" -u "username:password" -d "{test&test}" https://google.com?id=1');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --require PUT -H "Accept: application/json" -H "Authorization: Bearer {123456} -d "{test&test}" https://google.com?id=1');
    }
    ...
    public function testPossibleDeleteRequests(){
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl DELETE -H "Accept: application/json" https://google.com?id=1');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --require DELETE -H "Accept: application/json" https://google.com?id=1');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --require --location DELETE -H "Accept: application/json" https://google.com?id=1');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --require DELETE -H "Accept: application/json" -H "Authorization: Bearer {token}" https://google.com?id=1');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --require DELETE -H "Accept: application/json" -u "username:password" https://google.com?id=1');
        ...
        $this->assertEquals($request->getCurlTemplate(),'curl --require DELETE -H "Accept: application/json" -H "Authorization: Bearer {123456} https://google.com?id=1');
    }
}